<?php
class QuickViewStyle2 {

    public string $key = 'style_2';
    ...
    {
        return Template::img(Url::base().Path::plugin(QV_NAME).'/assets/images/style_2.png', '', ['return' => true]);
    }
    ...
    public function buildCss(): string
    {
        ...
        $css .= Template::less(file_get_contents(FCPATH.QV_PATH.'/styles/style2/css/style.less'))->getCss();
    ...
    public function html($object, $config): void
    {
        ...
        Plugin::view(QV_NAME, 'styles/style2/view/view', [
            'item' => $object,
            'config' => $config
        ]);
    }
