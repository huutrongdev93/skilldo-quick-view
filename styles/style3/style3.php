<?php
class QuickViewStyle3 {

    public string $key = 'style_3';
    ...
    {
        return Template::img(Url::base().Path::plugin(QV_NAME).'/assets/images/style_3.png', '', ['return' => true]);
    }
    ...
    public function buildCss(): string
    {
        ...
        $css .= Template::less(file_get_contents(FCPATH.QV_PATH.'/styles/style3/css/style.less'))->getCss();
    ...
    public function html($object, $config): void
    {
        ...
        Plugin::view(QV_NAME, 'styles/style3/view/view', [
            'item' => $object,
            'config' => $config
        ]);
    }
